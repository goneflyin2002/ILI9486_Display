...
- **MCU**: ESP32-C5 (may also compatible with other ESP32 variants)
...
**Note**: These are the tested pin assignments for the Waveshare ESP32-C5 devboard. The C5 has specific GPIO limitations, so these pins have been verified to work reliably.
